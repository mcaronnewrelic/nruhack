...
export default class Lab3Nerdlet extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.accountId = 1038287; //New Relic .
        this.state = {
            value: '',
            facet: '',
            hideModal: true,
                ...
                <Grid className="grid">
                    <GridItem
                        ...
                        <Stack
                            ...
                            <StackItem>
                                <BarChart className="lab3chart" query={errors + since + this.state.facet} accountId={this.accountId} />
                            </StackItem>
                        </Stack>
                    </GridItem>
                    <GridItem
                        ...
                        <Stack
                            ...
                            <StackItem>
                                <TableChart className="lab3chart" query={transaction_apdex_by_appname + since + this.state.facet} accountId={this.accountId} />
                            </StackItem>
                        </Stack>
                    </GridItem>
                </Grid>
