                        ...
                        <Stack
                            ...
                            <StackItem>
                                <Stack
                                    ...
                                    gapType={Stack.GAP_TYPE.EXTRA_LOOSE}>
                                    <StackItem>
                                        <TableChart query={nrql + since} accountId={this.accountId} className="lab2chart" onClickTable={(dataEl, row, chart) => {
                                            ...
                                            <StackItem>
                                                <Stack
                                                    ...
                                                    <StackItem>
                                                        ...
                                                        <LineChart accountId={this.accountId} query={tCountNrql + since} className="lab2chart" />
                                                    </StackItem>
                                                    <StackItem>
                                                        <h2>Apdex for {appName}</h2>
                                                        <ScatterChart accountId={this.accountId} query={apdexNrql + since} className="lab2chart" />
                                                    </StackItem>
                                                </Stack>
                                            </StackItem>
                                        </React.Fragment>
